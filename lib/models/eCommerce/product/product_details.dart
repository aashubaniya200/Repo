...
import 'package:webpal_commerce/models/eCommerce/flash_sales_list_model/running_flash_sale.dart';
...
class Product {
  ...
  factory Product.fromMap(Map<String, dynamic> map) {
    return Product(
      ...
      discountPrice: map['discount_price'] is String ? double.parse(map['discount_price']) : (map['discount_price'] as num).toDouble(),
      discountPercentage: map['discount_percentage'] is String ? double.parse(map['discount_percentage']) : (map['discount_percentage'] as num).toDouble(),
      ...
      quantity: map['quantity'] is String ? int.parse(map['quantity']) : map['quantity'] as int,
      isFavorite: map['is_favorite'] as bool,
      mrp: map['mrp'] != null 
        ? (map['mrp'] is String ? double.parse(map['mrp']) : (map['mrp'] as num).toDouble())
        : null,
...
class Color {
  ...
  factory Color.fromMap(Map<String, dynamic> map) {
    return Color(
      ...
      mediaId: map['media_id'] != null
        ? (map['media_id'] is String ? int.parse(map['media_id']) : map['media_id'] as int)
        : null,
    );
  }
...
class SizeModel {
  ...
  SizeModel.fromMap(Map<String, dynamic> json) {
    ...
    mediaId = json['media_id'] != null 
      ? (json['media_id'] is String ? int.parse(json['media_id']) : json['media_id'])
      : null;
  }
...
class ShopInfo {
  ...
  factory ShopInfo.fromMap(Map<String, dynamic> map) {
    return ShopInfo(
      ...
      deliveryCharge: map['delivery_charge'] is String ? double.parse(map['delivery_charge']) : (map['delivery_charge'] as num).toDouble(),
    );
  }
