...
import 'package:webpal_commerce/views/eCommerce/home/layouts/home_view_layout.dart';
            ...
            children: [
              ...
              InkWell(
                onTap: () {
                  ...
                  Share.share(
                      "Please check this product at $websiteUrl/${widget.productDetails.product.id}/details");
                },
                child: Card(
                    child: Padding(
              ...
              Row(
                children: [
                  ...
                  Visibility(
                    ...
                    child: Builder(
                      builder: (context) {
                        // Get MRP with priority: Size > Color > Product
                        final selectedSize = ref.watch(selectedSizeProvider);
                        final selectedColor = ref.watch(selectedColorProvider);
                        final mrp = selectedSize?.mrp ?? 
                                   selectedColor?.mrp ?? 
                                   widget.productDetails.product.mrp;
                        
                        // Only show MRP if it exists and is greater than selling price
                        final sellingPrice = widget.productDetails.product.discountPrice +
                            ref.watch(selectedColorPriceProvider) +
                            ref.watch(selectedSizePriceProvider);
                  ...
                  Visibility(
                    ...
                    child: Builder(
                      builder: (context) {
                        ...
                        // Calculate discount from MRP if available
                        final discountPercentage = mrp != null && mrp > sellingPrice
                            ? ((mrp - sellingPrice) / mrp * 100).toStringAsFixed(0)
                            : widget.productDetails.product.discountPercentage.toStringAsFixed(0);
