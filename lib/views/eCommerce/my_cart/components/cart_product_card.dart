...
import 'package:webpal_commerce/views/eCommerce/my_cart/components/gift_bottom_sheet.dart';
...
class CartProductCard extends ConsumerWidget {
          ...
          actions: [
            ...
            ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                backgroundColor: EcommerceAppColor.red,
                shape: RoundedRectangleBorder(
            ...
            children: [
              ...
              InkWell(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: EcommerceAppColor.red.withOpacity(0.1),
  ...
  Widget _buildProductBottomRow({
    ...
    return Consumer(builder: (context, ref, _) {
      ...
      final sellingPrice = product.discountPrice > 0 
