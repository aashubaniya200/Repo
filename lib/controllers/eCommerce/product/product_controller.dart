...
import '../../../models/eCommerce/product/product_details.dart' as pd;

final selectedColorPriceProvider = StateProvider<double>((ref) => 0);
final selectedSizePriceProvider = StateProvider<double>((ref) => 0);

// Providers to track selected color and size objects for MRP access
final selectedColorProvider = StateProvider<pd.Color?>((ref) => null);
final selectedSizeProvider = StateProvider<pd.SizeModel?>((ref) => null);
