...
import 'package:webpal_commerce/models/eCommerce/order/order_now_cart_model.dart';
import 'package:webpal_commerce/models/eCommerce/shop_message_model/shop.dart';
import 'package:webpal_commerce/views/common/authentication/change_password_view.dart';
import 'package:webpal_commerce/views/common/authentication/confirm_otp_view.dart';
import 'package:webpal_commerce/views/common/authentication/create_new_password_view.dart';
import 'package:webpal_commerce/views/common/authentication/layouts/confirm_otp_layout.dart';
import 'package:webpal_commerce/views/common/authentication/login_view.dart';
import 'package:webpal_commerce/views/common/authentication/recover_password_view.dart';
import 'package:webpal_commerce/views/common/authentication/sign_up_view.dart';
import 'package:webpal_commerce/views/common/blog/blog_details_view.dart';
import 'package:webpal_commerce/views/common/blog/blogs_view.dart';
import 'package:webpal_commerce/views/common/language/language_view.dart';
import 'package:webpal_commerce/views/common/onboarding/onboarding_view.dart';
import 'package:webpal_commerce/views/common/other/privacy_policy_view.dart';
import 'package:webpal_commerce/views/common/other/refund_policy_view.dart';
import 'package:webpal_commerce/views/common/other/terms_confitions_view.dart';
import 'package:webpal_commerce/views/common/splash/splash_view.dart';
import 'package:webpal_commerce/views/common/initial_screen.dart';
import 'package:webpal_commerce/views/common/support/supports_view.dart';
import 'package:webpal_commerce/views/eCommerce/address/add_update_address_view.dart';
import 'package:webpal_commerce/views/eCommerce/categories/categories_view.dart';
import 'package:webpal_commerce/views/eCommerce/checkout/checkout_view.dart';
import 'package:webpal_commerce/views/eCommerce/checkout/layouts/web_payment_page.dart';
import 'package:webpal_commerce/views/eCommerce/dashboard/dashboard_view.dart';
...
import 'package:webpal_commerce/views/eCommerce/home/layouts/flash_sale_details_layout.dart';
import 'package:webpal_commerce/views/eCommerce/manage_address/manage_address_view.dart';
import 'package:webpal_commerce/views/eCommerce/my_cart/my_cart_view.dart';
import 'package:webpal_commerce/views/eCommerce/my_message/my_chat_view.dart';
import 'package:webpal_commerce/views/eCommerce/my_message/my_message_view.dart';
import 'package:webpal_commerce/views/eCommerce/my_order/my_order_view.dart';
import 'package:webpal_commerce/views/eCommerce/notification/notification_view.dart';
import 'package:webpal_commerce/views/eCommerce/order_details/order_details_view.dart';
import 'package:webpal_commerce/views/eCommerce/order_now/order_now_view.dart';
import 'package:webpal_commerce/views/eCommerce/products/product_details_view.dart';
import 'package:webpal_commerce/views/eCommerce/products/products_view.dart';
import 'package:webpal_commerce/views/eCommerce/profile/profile_view.dart';
import 'package:webpal_commerce/views/eCommerce/return_order/layouts/return_order_list_layout.dart';
import 'package:webpal_commerce/views/eCommerce/return_order/return_order_details_view.dart';
import 'package:webpal_commerce/views/eCommerce/return_order/return_policy_product_view.dart';
import 'package:webpal_commerce/views/eCommerce/shops/shop_view.dart';
import 'package:webpal_commerce/views/eCommerce/shops/shops_view.dart';
import 'package:webpal_commerce/views/food/dashboard/dashboard_view.dart';
import 'package:webpal_commerce/views/food/home/home_view.dart';
import 'package:webpal_commerce/views/grocery/dashboard/dashboard_view.dart';
import 'package:webpal_commerce/views/grocery/home/home_view.dart';
import 'package:webpal_commerce/views/pharmacy/dashboard/dashboard_view.dart';
import 'package:webpal_commerce/views/pharmacy/home/home_view.dart';
