class AppConstants {
  static const String baseUrl = 'https://getinstantmart.com/api';
  ...
  static const String deleteCartProduct = '$baseUrl/cart/delete';
  ...
  static String appCurrency = "Rs.";
  static String appServiceName = 'ecommerce';

  static String pusherApiKey = 'a55bfb04d58dceceda4b';
