...
class HiveService {
  ...
  Future<User?> getUserInfo() async {
    ...
    Map<String, dynamic> userInfoStringKeys =
        Map<String, dynamic>.from(userInfo.cast<String, dynamic>());
    try {
  ...
  Future<AddAddress?> getDefaultAddress() async {
    ...
    if (defaultAddressData == null) return null;
    Map<String, dynamic> addressStringKeys =
        Map<String, dynamic>.from(defaultAddressData.cast<String, dynamic>());
    try {
